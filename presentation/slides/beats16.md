...
A desigualdade vale pois cada existem no máximo $n \log n$ nós que contribuem com no máximo 1 para o potencial.
...
Com isso, acabamos de provar que o potencial continua diminuindo em pelo menos 1 toda vez que visitamos uma subtree que contem um nó não terminal. Como essa subtree contêm $\mathcal{O}(\log n)$ nós, o potencial diminui em $\frac{1}{\log n}$.